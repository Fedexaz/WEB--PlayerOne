...
<!doctype html>
  ...
  <head>
    <title>Player One - Iniciar sesión</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link text-success" rel="tooltip" title="" data-placement="bottom" href="../user/register.php" data-original-title="Registrate en Player One" rel="nofollow">
                <i class="material-icons">person_add</i> Registro
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" rel="tooltip" title="" data-placement="bottom" href="darkmodelogin.php" data-original-title="Activar/Desactivar modo oscuro" rel="nofollow">
    ...
    <div class="main main-raised" <?php if($_SESSION['modoNoche'] == true) {echo 'style="background-color:#000001;"';}else{ echo 'class="bg-light"';} ?> style=" font-family: Courier, 'Lucida Console', monospace">
      <div class="container">
        <div class="section text-center fade">
          <h2 style="font-family: Courier, 'Lucida Console', monospace" <?php if($_SESSION['modoNoche'] == true) {echo 'class="title text-light"';}else{ echo 'class="title text-dark"';} ?>>INICIAR SESIÓN</h2>
          <div class="row">
            <div class="col-md-4">
              <div class="card bg-transparent">
                <div class="card-body">
                  <h3 style="font-family: Courier, 'Lucida Console', monospace" <?php if($_SESSION['modoNoche'] == true) {echo 'class="text-light"';}else{ echo 'class="text-dark"';} ?>>¡Inicia sesión en Player One!</h3>
                  <p  style="font-family: Courier, 'Lucida Console', monospace" <?php if($_SESSION['modoNoche'] == true) {echo 'class="text-light"';}else{ echo 'class="text-dark"';} ?>>¡Tendrás acceso a muchas funciones de la plataforma!<br>
                    ¿No Tienes una <b>cuenta</b>? <a href="register.php" class="alert-link"><b>Registrate</b></a></p>
                  </div>
                </div>
              </div>
              <div class="col-md-8">
                <form action="cLogin.php" method="POST">
                  <div class="row">
                    <div class="col-md-12 mt-5">
                      ...
                      <input type="text" name="usuario" style="font-family: Courier, 'Lucida Console', monospace" placeholder="Ingresa tu nombre de usuario." class="form-control" required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 mt-3">
                      ...
                      <input type="password" name="pass" style="font-family: Courier, 'Lucida Console', monospace" placeholder="Ingresa tu contraseña." class="form-control" required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <input type="submit" value="Iniciar sesión" class="mt-4 btn btn-primary">
                    </div>
                  </div>
                </form>
              </div>
